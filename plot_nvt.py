...
thermo_file = Path('data/thermo_nvt.txt')
thermostat_file = Path('data/thermostat_nvt.txt')
FS = 12
...
# axt.legend()
figt.savefig('figures/nvt_T_and_P_and_E.pdf', bbox_inches='tight')
...
fig.savefig('figures/nvt_xi.pdf')
